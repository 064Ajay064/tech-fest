...
import LoginForm from '@/features/registration/components/LoginForm'
        ...
        <PageTransition>
          <Container>
            ...
            <section className="text-center mb-20 animate-fadeInUp">
              ...
              <p className="text-gray-400 text-lg sm:text-xl font-medium max-w-2xl mx-auto leading-relaxed italic px-4">
