        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="flex justify-center animate-fadeInUp" style={{ animationDelay: '200ms' }}>
            <div className="relative group">
              ...
              <div className="relative glass p-12 rounded-[3rem] border-white/5 shadow-2xl flex flex-col items-center">
                <div className="text-8xl mb-6 animate-float">🤖</div>
                <div className="h-2 w-24 bg-primary/30 rounded-full blur-sm mb-4"></div>
                <p className="text-primary-light font-black tracking-[0.3em] text-[10px]">CORE ENGINE ACTIVATED</p>
              </div>
            </div>
          </div>
        </div>
